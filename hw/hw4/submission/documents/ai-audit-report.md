...
- Decision: PENDING
- Evidence: `docs/git-commit-log.txt`, `docs/ai-audit-report.md`, and `origin/homework4`.
...
- Decision: PENDING
- Evidence: `23127334_HW04_AI_Automation_100/` and the final structural checks.
...
- Decision: PENDING
- Evidence: `documents/bug-report.md` and `evidence/bug-screenshots/` in the final submission folder.
...
- Decision: PENDING
- Evidence: `automation/rest/fr14-bug-evidence.rest` and the live GET health check.
...
- Decision: PENDING
- Evidence: the three student-created screenshots and the updated submission bug report.
...
- Decision: PENDING
- Evidence: `documents/video-script.md` in the final submission folder.
...
- Decision: PENDING
- Evidence: assignment PDF, policy PDF, current source/data, manifest/reports, final submission folder, and GitHub Issues #33–#40.
...
- Decision: PENDING
- Evidence: latest `.last-run.json`, error contexts, and the previously verified 9-run manifest.
...
- Decision: PENDING
- Evidence: supplied YouTube URL, synchronized Markdown files, cleanup inventory, final structural check, Git log, and GitHub Issues #33–#40.
...
- Decision: PENDING
- Evidence: before/after inventory, required-path check, nine report entry points, temporary ZIP size check, and synchronized submission folders.
...
- Decision: PENDING
- Evidence: final submission automation inventory and package scripts.
...
- Decision: PENDING
- Evidence: HW04 section 7 (Agent Skill) and section 14 (Required contents of the ZIP), plus the general homework policy.
