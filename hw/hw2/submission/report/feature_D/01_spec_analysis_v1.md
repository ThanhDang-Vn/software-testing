# STEP 1 — Spec Analysis: FR-07 Mobile Shopping Cart (feature_D) (v1)
...
> **v1 change:** Bỏ sub-flow Thanh toán (Checkout) khỏi phạm vi phân tích. Feature_D tập trung vào các thao tác giỏ hàng: Thêm, Xem, Chỉnh số lượng, Xóa.
...
| 2 | Nhãn "Tổng tạm tính" thay vì "Tổng cộng" | Vi phạm FR-07 | Low |
| 3 | Không có nút +/- chỉnh số lượng, dùng TextInput | Vi phạm FR-07 | Medium |
| 4 | Xóa sản phẩm không có confirm dialog | Vi phạm FR-07 | Medium |
| 5 | Empty state thiếu hình minh họa | Vi phạm FR-07 | Low |
