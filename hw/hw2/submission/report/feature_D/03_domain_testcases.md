# STEP 3 — Domain Test Cases: FR-07 Mobile Shopping Cart (feature_D)
...
| DT-D-014 | Cart inline edit | quantity | EC-QE-I2 | Invalid | Nhập `"0"` vào ô quantity | quantity fallback = 1. Không hiển thị lỗi. |
