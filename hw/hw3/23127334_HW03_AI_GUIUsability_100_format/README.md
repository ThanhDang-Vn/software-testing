...
- GUI screens: Login (`FR-02`) and Order History within Profile (`FR-11`).
- Usability flow: sign in, independently locate order history, and identify the
  latest order's ID, date, total, and current status.
- Usability scale: SUS.
- Scope uniqueness within group: confirmed by the student.
...
- `gui-checklist-v0-agent.xlsx`: untouched 32-item AI baseline before review.
- `gui-checklist-v1-reviewed.xlsx`: current 45-item, standards-reviewed GUI checklist.

The versions are kept in separate workbooks. Continue editing only v1; keep v0
unchanged as evidence of the initial AI output.
