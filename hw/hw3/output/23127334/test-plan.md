...
- [x] Có đồng thuận tham gia/ghi hình nếu áp dụng.
- [x] Dùng mã P01–P03, không ghi dữ liệu cá nhân không cần thiết.
- [x] Đăng nhập sẵn tài khoản test; xác nhận wishlist đang trống.
- [x] Xác minh từ khóa phim đã chuẩn bị thực sự ra kết quả trên hệ thống.
- [x] Kiểm tra website và đồng hồ bấm giờ.
- [x] Chuẩn hóa start state (trang chủ, chưa tìm kiếm).
- [x] Không tập trước flow cho người tham gia; nói rõ "test hệ thống, không test bạn".
