...
- Repository (public): https://github.com/ThanhDang-Vn/software-testing (test plan + data file trong `hw/hw5/`)
...
│   └── ai-audit-report.md     nhật ký dùng AI (§9)
